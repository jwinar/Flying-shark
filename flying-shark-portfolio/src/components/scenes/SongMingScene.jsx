...
const SongMingScene = () => {
  ...
  return (
    <div ref={containerRef} style={{ height: '100vh', position: 'relative', overflow: 'hidden', background: '#0a0f0e' }}>
      ...
      <div ref={charRef} style={{ position: 'absolute', top: '46%', left: '50%', transform: 'translate(-50%,-50%)', fontSize: 'clamp(160px,34vw,460px)', fontFamily: 'var(--font-display)', color: '#a8c4bc', pointerEvents: 'none', zIndex: 4 }}>墨</div>
      ...
      <AmbientTrack src="/assets/audio/songming-ambient.mp3" inView={inViewport} volume={0.35} />
    </div>
  );
};
