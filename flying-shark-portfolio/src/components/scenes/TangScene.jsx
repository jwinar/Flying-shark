...
const TangScene = () => {
  ...
  return (
    <div ref={containerRef} style={{ height: '100vh', position: 'relative', overflow: 'hidden', background: '#140a06' }}>
      ...
      <div ref={charRef} style={{ position: 'absolute', top: '46%', left: '50%', transform: 'translate(-50%,-50%)', fontSize: 'clamp(160px,34vw,460px)', fontFamily: 'var(--font-display)', color: '#c9a84c', pointerEvents: 'none', zIndex: 4 }}>唐</div>
      ...
      <AmbientTrack src="/assets/audio/tang-ambient.mp3" inView={inViewport} volume={0.35} />
    </div>
  );
};
